...
urlpatterns = [
    ...
    path("password-change/", views.guest_blocked(auth_views.PasswordChangeView.as_view(template_name="accounts/password_change.html", success_url="/accounts/password-change/done/")), name="password_change"),
