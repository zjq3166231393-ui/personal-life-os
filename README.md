...
| v0.7 | 190 | 8 | 看板/建议 |
| v0.8 | 190 | 7 | 安全/部署 |
| v0.9 | 726 | 12+ | 功能差距清零 + 工程质量/打磨（搜索/导出/导入/标签/多账本/日历/OCR/游戏化/批量/多币种/滑动手势 + 迁移漂移防护 + 测试缺口补齐） |
| v1.0 | — | — | 下一里程碑：推送发送端、架构文档刷新、模型按领域拆分（详见 `docs/v1-release-audit.md` 十五章） |
